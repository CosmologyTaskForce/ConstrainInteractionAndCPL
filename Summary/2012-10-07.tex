...
\item
NOT monotonic. Thus it is not clear what is the importance of the value of $w$. The result of $\xi$ is greatly affected by $\Omega m0$. In correspondence with another 
\item
...
(Figures \ref{fig-rhoc_ICCPL_Quintom_EoS}, \ref{fig-rhoc_ICCPL_Quintom_TransVSOmegam0}, \ref{fig-rhoc_ICCPL_Quintom_xiVSOmegam0})
